$(document).ready(function(){
    ...
    $(".add-to-selection").on("click", function(){
        ...
        console.log(`library_title   : ${library_title     }`);
        ...
        $.ajax({
            url:'/barrowing/add_to_selection/',
            data: {
                'id': id,
	...
	$(document).on('click','.delete-item',function(){
		...
		$.ajax({
			url:'/barrowing/delete_selection/',
			data:{
				'id':id,
			},
			dataType:'json',
    ...
    // Add to librarymark
    $(document).on('click', '#add-to-librarymark', function(){
        let button = $(this)
        let id = button.attr("data-library")
        console.log(id);

        $.ajax({
            url:"/dashboard/add_to_librarymark/",
            beforeSend: function(){
            ...
            success: function(res){
                ...
                if (res.data == "Login To Bookmark Library") {
                    button.html('<i class="fas fa-heart" style="color: gray;"></i>')
                } 
            }
        })
