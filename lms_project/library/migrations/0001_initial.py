    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barrowing_id', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnopqrstuvxyz', length=10, max_length=20, prefix='', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Bookmark',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='media/book.jpg', upload_to='library_gallery')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Barrowing Confirmed', 'Barrowing Confirmed'), ('Barrowing Cancelled', 'Barrowing Cancelled')], default='new_order', max_length=100)),
